...
class DrinkingbowTable extends React.Component {
  ...
  handleRemoveData = ()=> {
    this.props.removeFromTable('drinking_bowl')
  }
  ...
  render() {
    ...
    let table = drinking_bowl.map(function (item, index) {
      return (
        ...
        <tr key={index}>
          <td style={{width:'16%'}} className="active">Field {item.brand}</td>
          <td style={{width:'16%'}} className="active">Field {item.water_volume}</td>
          <td style={{width:'16%'}} className="active">Field {item.seats}</td>
          <td style={{width:'16%'}} className="active">Field {item.heads}</td>
          <td style={{width:'16%'}} className="active">Field {item.weight}</td>
